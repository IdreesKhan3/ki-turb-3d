...
def get_plot_style(plot_name: str):
    ...
    if "Dark" in current_theme:
        # Only update if colors are at their light theme defaults (not customized)
        if merged.get("pope_color") == "#000000":
            merged["pope_color"] = "#4ec9b0"  # Cyan/turquoise - visible on dark background
        if merged.get("kolmogorov_color") == "#666666":
            merged["kolmogorov_color"] = "#dcdcaa"  # Light yellow - visible on dark background
