...
# Here i make a short instructions section about the app connects to chatboat and finally how it works with LLM
# FIrst of all about the data privacy (if the user is concerend about) the code has options CLI as well API options. For CLI
# the code uses Olamma LLM model which is totally offline and all the user data stays on his/her machine jsut depends on 
# which model version you want to use. the most advanced version occupation size may exceed to 40GB and may also run slower
# On cpu.
#On the other hand the app has the option to run on OPenAI and 
