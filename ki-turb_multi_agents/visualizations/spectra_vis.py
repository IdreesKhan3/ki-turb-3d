"""
Shared spectrum visualization for energy spectrum plots.
...
for _kiturb_name in ('create_raw_spectrum_figure', 'create_normalized_spectrum_figure', 'create_time_evolution_figure', 'create_spectrum_figure',):
