...
REM ============================================
REM Gemini: https://makersuite.google.com/app/apikey
REM set GOOGLE_API_KEY=your-gemini-api-key-here

REM DeepSeek: https://platform.deepseek.com/api_keys # currently i am using it
REM set DEEPSEEK_API_KEY=your-deepseek-api-key-here
REM set DEEPSEEK_MODEL=deepseek-v4-pro
