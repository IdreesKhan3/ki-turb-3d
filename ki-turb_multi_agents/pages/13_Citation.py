...
def main() -> None:
    ...
    st.caption(
        "Machine-readable citation metadata also ships as `CITATION.cff` "
        "(version 3.0.0) in the repository root."
    )

    st.info(
        "A persistent DOI is not yet assigned for this software. "
        "Please cite the software version (3.0.0) and repository URL. "
