...
def main():
    ...
    # Process ALL directories — velocity volumes only (exclude density/vorticity dumps)
    from utils.file_detector import list_velocity_field_files

    all_files_paths = list_velocity_field_files(data_dirs)
    ...
    all_files = [Path(f).name for f in all_files_paths]
