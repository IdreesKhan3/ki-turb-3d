"""
Turbulence metrics computation for vortex visualization.

Computes Q-criterion, Q_S^S method, and related invariants used for iso-surfaces
and volume rendering (e.g. in the 3D Volume Viewer).
"""
