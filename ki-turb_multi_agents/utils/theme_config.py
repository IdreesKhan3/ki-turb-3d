...
THEMES = {
    "Light Scientific": {
        ...
        "title_size": 16,
        "legend_size": 12,
        "legend_position": "Default (top-right outside)",
        "legend_x": None,
        "legend_y": None,
        "legend_xanchor": None,
        "legend_yanchor": None,
    ...
    "Dark Scientific": {
        ...
        "description": "Dark theme for extended viewing",
        "plot_bgcolor": "#1e1e1e",
...
def apply_theme_to_plot_style(plot_style: dict, theme_name: str) -> dict:
    ...
    updated_style["legend_position"] = theme.get("legend_position", "Default (top-right outside)")
    updated_style["legend_x"] = theme.get("legend_x")
    updated_style["legend_y"] = theme.get("legend_y")
    updated_style["legend_xanchor"] = theme.get("legend_xanchor")
    updated_style["legend_yanchor"] = theme.get("legend_yanchor")
